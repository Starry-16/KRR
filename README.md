...
7.  ./OpenKE-OpenKE-PyTorch/checkpoint/transe.ckpt和transh.ckpt是已经训练好的参数文件，如有需要请在百度网盘自行下载 [链接：](https://pan.baidu.com/s/1GmYVHG7warRzFlk7528JAA)提取码：0lgq，并放在./OpenKE-OpenKE-PyTorch/checkpoint/文件夹下，或者可以参照第5步自行训练
